...
```sh
mvn archetype:generate -DarchetypeGroupId=com.intuit.benten -DarchetypeArtifactId=benten-archetype -DarchetypeVersion=0.1.4 -DgroupId=com.mycompany -DartifactId=benten-starter
cd benten-starter
