 ...
 */
@Component
@ActionHandler(action = JenkinsActions.ACTION_JENKINS_JOBDETAILS_BY_JOBNAME)
public class JenkinsJobDetailsByJobNameActionHandler implements BentenActionHandler {
